...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def modify_widgets(self):
        ...
        self.sld_iconSize.setRange(64, 256)
        self.sld_iconSize.setValue(64)
    ...
    def add_widgets_to_layouts(self):
        self.addToolBar(QtCore.Qt.TopToolBarArea, self.toolbar) #Ajouter la tool bar
    ...
    def add_action_to_toolbar(self):
        locations = ["home", "desktop", "documents", "pictures", "music", "download", "movies"]
