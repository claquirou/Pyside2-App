...
class MainWindow(QtWidgets.QWidget):
    ...
    def create_widgets(self):
        ...
        self.prg_dialog = QtWidgets.QProgressBar()
    ...
    def add_widgets_to_layouts(self):
        ...
        self.main_layout.addWidget(self.prg_dialog, 5, 0, 1, 2)
        self.main_layout.addWidget(self.btn_convert, 6, 1, 1, 1)
        self.main_layout.addWidget(self.btn_cancel, 6, 0, 1, 1)
    ...
    def setup_connections(self):
        ...
        self.btn_cancel.clicked.connect(self.abort)
    ...
    def convert_images(self):
        ...
        self.prg_dialog.setRange(1, len(images_a_convertir))
